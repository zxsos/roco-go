...
| pcap | 时长 | 倍率 | speed 均值 |
| --- | --- | --- | --- |
| 13_26_20 | 21s | 16.90 | 904 |
| 13_26_20 | 12s | 25.83 | 714 |
| 15_36_58 | 20s | 23.75 | 898 |
| 15_36_58 | 29s | 22.24 | 583 |
| 15_36_58 | 18s | 25.83 | 371 |

**与速度无单调关系**(speed 371 反而倍率最高),量级约 17~26。故 ETA 仍按活动
倍率(保守值)算,不折算移动加成;等分工况(地面跑 / 骑乘 / 飞行)各抓一段
「静止 60s + 移动 60s」的对照样本再定。
